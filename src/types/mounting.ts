 ...
 */
  ...
  /** * 🔥 НОВОЕ: Массив конкретных дат монтажа (YYYY-MM-DD).
   * Заменяет логику (mountingDate + durationDays).
   * Позволяет ставить один заказ на разрозненные дни (например, Пн и Чт).
   */
